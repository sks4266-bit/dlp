    ...
    <div style={page}>
      ...
      <main style={wrap}>
        <section style={hero}>
          ...
          <p style={heroDesc}>
            홈 화면 톤 그대로, 모바일 한 열 구조에 맞춰 공지·기도·공동체 채널을 편하게 둘러보고
            바로 채널을 만들 수 있게 정리했습니다.
          </p>
        </section>
        ...
        <Card pad style={heroCard}>
          <div style={heroRow}>
            <div>
              <CardTitle style={bigCardTitle}>공지와 기도제목을 한곳에</CardTitle>
              <CardDesc style={bigCardDesc}>
                추천 채널과 전체 채널을 한 번에 살펴보고, 필요한 공동체 채널을 바로 열어볼 수 있어요.
              </CardDesc>
            </div>
